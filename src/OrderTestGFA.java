...
public class OrderTestGFA {
	...
	public void testCalcOrderTotal() {
		orderOne.addNewBeverage("regular Coffee", Size.SMALL, false, false); //2 
		orderOne.addNewBeverage("Mohito", Size.SMALL); //2 
		orderOne.addNewBeverage("Detox", Size.MEDIUM, 1, false);//3
